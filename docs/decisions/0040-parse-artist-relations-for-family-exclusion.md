# ADR 0040: Parse real Discogs group/member relations instead of hand-curating an exclusion list
...
generation. This sits alongside, and independent of, ADR 0039's performer-role
