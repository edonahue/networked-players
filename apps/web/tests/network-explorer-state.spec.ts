...
function starGraph(): PathfindingGraph {
  return {
    ...
    offsets: new Int32Array([0, 3, 4, 5, 6]),
    neighbors: new Int32Array([1, 2, 3, 0, 0, 0]),
    evidence_release_ids: new Int32Array([1, 2, 3, 1, 2, 3]),
    edge_role_a: [
      "Producer",
      "Producer",
      "Producer",
...
function starGraphWithAlbumAnchor(): PathfindingGraph {
  return {
    ...
    source: "test",
    license: "test",
    node_ids: new Int32Array([-1, 100, 200, 300, 400]),
    names: ["First Light (album anchor)", "Alice", "Bob", "Cara", "Dan"],
    offsets: new Int32Array([0, 1, 5, 6, 7, 8]),
    neighbors: new Int32Array([1, 0, 2, 3, 4, 1, 1, 1]),
    evidence_release_ids: new Int32Array([10, 10, 1, 2, 3, 1, 2, 3]),
    edge_role_a: [
      ALBUM_ANCHOR_SENTINEL,
      "Producer",
      "Producer",
